...
std::string PrintValue(const std::string& name,
...
void DumpExtensions(const tinygltf::ExtensionMap& extension,
    const int indent) {
...
void DumpTextureInfo(const tinygltf::TextureInfo& texinfo,
    const int indent) {
...
void DumpNormalTextureInfo(const tinygltf::NormalTextureInfo& texinfo,
    const int indent) {
    std::cout << Indent(indent) << "index     : " << texinfo.index << "\n";
    std::cout << Indent(indent) << "texCoord  : TEXCOORD_" << texinfo.texCoord
        << "\n";
...
void DumpPbrMetallicRoughness(const tinygltf::PbrMetallicRoughness& pbr,
    const int indent) {
    std::cout << Indent(indent)
